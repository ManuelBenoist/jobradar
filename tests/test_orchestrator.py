...
def test_run_daily_ingestion_calls_sources_with_query_label(monkeypatch):
    ...
    def fake_france_travail_offers(*args, **kwargs):
        collected.append(("france_travail", kwargs.get("keywords"), kwargs.get("query_name")))
    ...
    monkeypatch.setattr("ingestion.orchestrator.fetch_france_travail_offers", fake_france_travail_offers)
